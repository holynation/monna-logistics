    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h4 class="nk-block-title page-title">Upload Generated Numbers</h4>
                        ...
                        <div class="col-sm-12">
                            <form action="<?php echo base_url('mc/upload_timestamp'); ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="form-label" for="customFileLabel">Upload New Generated Numbers</label>
                                    <div class="form-control-wrap mb-4">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="customFile" name="numbers-upload">
                                            <label class="custom-file-label" for="customFile">Choose file</label>
                                            <span class='form-text text-muted'>Supported formats: <code> .csv only</code></span>
                                        </div>
                                    </div>
                                    <input type="hidden" name="upload_type" value="upload_numbers" />
                                    <div class="form-group align-self-center">
                                      <input type="submit" name="btnTimestamp" class="btn btn-primary" value="Upload Generated Numbers" />
                                    </div>
                                </div>
                            </form>
                            ...
                            <?php
                              $tableAction = [];
                              $tableExclude = [];
                              $queryString = "SELECT generated_numbers.ID, timestamp_numbers,date_created from generated_numbers";
