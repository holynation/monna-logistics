...
class AdminData {
	...
	public function loadDashboardData() {
		...
		$countData = $invoices->getInvoiceCountData();
		$amountData = $invoices->getInvoiceAmountData();
		$amountData2 = $invoices->getMOnthlyInvoiceAmountData();

		$result['transactionContent'] = $invoices->all($total, false, 0, 20);
		$result['invoiceCountData'] = json_encode($countData);
		$result['invoiceAmountData'] = json_encode($amountData);
		$result['invoiceAmountData2'] = json_encode($amountData2);
